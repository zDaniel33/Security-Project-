...
$link = mysqli_connect("localhost", "root", "password", "your database");
...
$sql = "INSERT INTO Employees (id,firstname,lastname, phone, email, salary) VALUES ('$idclean', '$fnameclean','$lnameclean','$phoneclean', '$emailclean', '$salaryclean')";
